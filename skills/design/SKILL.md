...
when_to_use: "디자인, 페이지 만들어줘, 컴포넌트 만들어줘, 보기 안 좋아, 어색해, 스타일, 프론트엔드, UI, build page, create component, make it look good, style, design, screenshot with visual complaint"
metadata:
  version: "3.18.0"
---
...
Activate when the user sends a screenshot or image alongside a complaint ("여기 별로야", "이거 이상해", "fix this", "looks wrong"). The existing product is the direction. Skip the five-question direction lock.
